...
export default function Home() {
    ...
    const getId = async (postID) => {
        ...
        if(isLiked) {
            ...
            await supabase.from('likes').delete().eq('tweet_id', postID).eq('tweetprofile', isactive?.id);
        }else {
            setLikedPost([...likedPost, postID]);
            const { data, error } = await supabase
            .from('likes')
            .insert([
            { tweet_id: postID, tweetprofile: isactive?.id },
            ]).select()
        }
    }
    ...
    return(
        ...
        <div className="filterTweet">
            <button className="filterForyou border textwhite">Sana özel
            </button>
        ...
        <div className="postArea" key={post.id}>
            ...
            <div className="postOtherDetails">
                ...
                <div className="postIcons">
                    ...
                    <button className="postLikeIcon" onClick={() => getId(post.id)}>
