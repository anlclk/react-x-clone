    ...
    return(
        <nav className="navbar">
            <Link to="/" className="navbarLink">
                <div className="navbarBox" style={{ width: '150px' }}>
            ...
            <Link to="/explore" className="navbarLink">
                <div className="navbarBox" style={{ width: '130px' }}>
                    <svg viewBox="0 0 24 24" width="24" height="24" className="navbarSvg" >
                        <path 
                        fill="#fff"
            ...
            <Link to="/notification" className="navbarLink">
                <div className="navbarBox" style={{ width: '170px' }}>
                    <svg viewBox="0 0 24 24" width="24" height="24" className="navbarSvg">
                        <path
                            fill="#fff" 
            ...
            <Link to="/premium" className="navbarLink">
                <div className="navbarBox" style={{ width: '160px' }}>
                    <svg viewBox="0 0 24 24" width="24" height="24" className="navbarSvg">
                        <path 
                           fill="#fff"
            ...
            <Link to="/bookmarks" className="navbarLink">
                    <div className="navbarBox" style={{ width: '190px' }}>
                        <svg viewBox="0 0 24 24" width="24" height="24" className="navbarSvg">
                            <path 
                            fill="#fff"
